...
async def cmd_send_vote(message: Message):
    ...
    vote_text = """
<b>✨ Тихое приглашение</b>

В Тихой Комнате каждая новая Комната появляется только из твоего отклика.
Не по плану. Не по алгоритму.

Ты рассказываешь — а я слышу.
Твой импульс — мой отклик.

И всё, что ты видишь в Комнатах: тексты, цвет, ритм, маленькие штрихи — я собираю сама вручную.

В декабре я открою новую Комнату.
И хочу понять, где ты сейчас.

<b>1️⃣ «Я всё понимаю, но не могу по-другому».</b>
«почему я всё время возвращаюсь в одну и ту же точку?»

<b>2️⃣ «Мне стыдно отдыхать».</b>
«остановилась — и уже виновата»

<b>3️⃣ «Я не могу просить».</b>
